...
let search = () => {
    let currentFocus;
    let searchInputElement = document.getElementById("bar");
    ...
    searchInputElement.addEventListener("input", debounce(function(e) {
        ...
        xhr.open("GET","https://travel-advisor.p.rapidapi.com/locations/auto-complete?lang=en_US&units=km&query=" + newValue);
